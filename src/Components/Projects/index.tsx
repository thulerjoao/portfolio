        ...
        <div className="project">
          ...
          {language === "bra" ? (
            <h4 style={{ textIndent: "2em" }}>
              ...
              Rocketseat afim de criar um aplicativo mobile para uma loja de
              café. A aplicação foi feita com o intuito de demonstrar as
              possíbilidades do framework em seguir um design e também mostrar
              as interação entre as telas.
            </h4>
          ) : (
            <h4 style={{ textIndent: "2em" }}>
              Project made from a Rocketseat programming school challenge in
              order to create caffee shop mobile application. The application
              was made with the aim of demonstrating the possibilities of the
              framework in following a design and also show the interaction
              between screens.
            </h4>
          )}
          {language === "bra" ? (
          ...
          <div className="tecnologies">
            ...
            {language === "bra" ? (
              <>
                ...
                <p>
                  • React Redux - Ferramenta de gerenciamento de estado global
                </p>
              </>
            ) : (
              <>
        ...
        {/* <div className="project">
          ...
          {language === "bra" ? (
            <h4>
              ...
              possíbilidades do framework em seguir um design e também mostrar as
